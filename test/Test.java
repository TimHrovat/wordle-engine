 ...
 */
public class Test implements Stroj {
    ...
    private static class Node {
        ...
        public String generateGuess() {
            return this.generateGuess(new StringBuilder()).toString();
        }

        /** generates a new guess as a string builder */
        private StringBuilder generateGuess(StringBuilder sb) {
